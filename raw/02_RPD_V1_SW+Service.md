# 제조 AI 자동화 플랫폼 (FactoryAI) — PRD v1.0
- **Owner 팀**: 모두연 EGIGAE #5
- **최종 업데이트**: 2026-04-11
- **원천 문서**: VPS V3 Updated Final (`▶06_VPS_V3_Updated_1_20260411_final.md`)
- **상태**: V1 — SW + Service 하이브리드 통합 완료
- **변경 이력**: v0.1(SW Only) → v1.0(SW+Service 하이브리드 관점 전면 보강)
...
| 보조-8 | **PoC→정식계약 전환율** | N/A | **≥60%** | 반기 | SVC |
...
*버전: PRD v1.0 (SW+Service 하이브리드) / 작성일: 2026-04-11 / Owner: 모두연 EGIGAE #5*

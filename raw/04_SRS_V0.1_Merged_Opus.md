...
**Document ID**: SRS-002  
**Revision**: 0.1 (Merged + Review)  
**Date**: 2026-04-18  
**Standard**: ISO/IEC/IEEE 29148:2018  

**Project**: 제조 AI 자동화 플랫폼 (FactoryAI)  
**Source PRD**: PRD v1.0 (2026-04-15)  
**Owner**: 모두연 EGIGAE #5  
...
|:---:|:---|:---:|:---:|:---:|:---|:---|
| R1 | **정부 바우처 예산 삭감** → 구축비 모델 붕괴 | 행정 | 🔴 | 중 | Year 2에 MRR 30%+ 자립. 바우처는 '채널'로만 활용 | REQ-NF-028, ADR-6 |
...
*Document ID: SRS-002 / Revision: 1.1 (Merged + Review) / Date: 2026-04-18 / Owner: 모두연 EGIGAE #5*  
*Base: SRS_V0.1_Opus + SRS_V0.1_Gemini 합본 → 검토 보고서 기반 보강*  
*총 요구사항: **72 REQ-FUNC** (기존 59 + SVC NAC 13건), **54 REQ-NF** (기존 48 + 보강 6건), **14 Entities** (기존 13 + USER), **9 Sequences**, **4 Diagrams** (Use Case, Component, ERD, Class)*

...
| R5 | **MRR 미정착** → Year 2 자립 실패 | SW | 🟡 | 중 | E7 성과 대시보드 리텐션 정당화 |
...
| **H9. 가치 입증 및 WTP (순수 자비 구독)** | 대시보드 누적 절감액 기반 자비 연장 제안 | 자비 유지/구독 갱신율 | 전환율 **≥60%** (절감액>MRR 시 이탈 0%) | SVC |
...
| **▶10 JTBD 인터뷰** | 14인 인터뷰, 6가설, Switch Trigger, 인용문 | §1, §3 |
| **▶11 BMC** | 수익 구조 (SI 60%+SaaS 25%+컨설팅 15%) | §7 |
...
*버전: PRD v2.0 (검증 및 가설 보완) / 작성일: 2026-04-11 / Owner: 모두연 EGIGAE #5*
